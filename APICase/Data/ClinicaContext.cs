...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source=(localdb)\\MSSQLLocalDB;Initial Catalog=Clinica");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Consulta>(entity =>
            {
                ...
                entity.HasOne(d => d.IdMedicoNavigation)
                    ...
                    .HasConstraintName("FK__Consulta__IdMedi__440B1D61");
            ...
            modelBuilder.Entity<Paciente>(entity =>
            {
                ...
                entity.Property(e => e.Carterinha).IsUnicode(false);
                ...
                entity.HasOne(d => d.IdUsuarioNavigation)
                    ...
                    .HasForeignKey(d => d.IdUsuario)
                    .HasConstraintName("FK__Paciente__IdUsua__412EB0B6");
            });
